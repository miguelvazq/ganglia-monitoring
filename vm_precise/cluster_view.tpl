...
<A HREF="./graph.php?g=query_count_report&amp;z=large&amp;{graph_args}">
<IMG BORDER=0 ALT="{cluster} QUERY"
   SRC="./graph.php?g=query_count_report&amp;z=medium&amp;{graph_args}">
</A>
<A HREF="./graph.php?g=query_count_s_report&amp;z=large&amp;{graph_args}">
<IMG BORDER=0 ALT="{cluster} QUERY_S"
   SRC="./graph.php?g=query_count_s_report&amp;z=medium&amp;{graph_args}">
</A>
