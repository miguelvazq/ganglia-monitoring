...
<A HREF="./graph.php?g=query_count_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} QUERY"
   SRC="./graph.php?g=query_count_report&z=medium&c={cluster_url}&{graphargs}">
</A>
<A HREF="./graph.php?g=query_count_s_report&z=large&c={cluster_url}&{graphargs}">
<IMG BORDER=0 ALT="{cluster_url} QUERY_S"
   SRC="./graph.php?g=query_count_s_report&z=medium&c={cluster_url}&{graphargs}">
</A>
