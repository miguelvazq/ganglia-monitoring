...
define([
    ...
    "dijit/PopupMenuItem",
                ...
                DelayLoadWidget, GangliaFilterDropDownWidget, WsRrd,
                template,
    ...
    return declare("GangliaWidget", [_TabContainerWidget], {
        ...
        _buildMetrics: function (newValue) {
            var context = this;
            context.metricsTargetSelect.required = false;
        ...
        _onFilterApply: function () {
            ...
            pMenu.addChild(new MenuItem({
                label: "Delete Graph",
                onClick: function(){domConstruct.destroy(this.getParent().currentTarget);}

            }));
             pMenu.addChild(new MenuItem({
                label: "Popout Graph",
                onClick: function(){alert("popped out!");}
